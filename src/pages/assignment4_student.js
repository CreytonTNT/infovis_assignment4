...
//Hint: use d3.scaleBand for xScaleBar
    ...
    return (
        <Container>
            ...
            <Row className='justify-content-md-center'>
                <Col>
                    <svg width={WIDTH} height={HEIGHT}>
                        ...
                        height={innerHeightScatter} width={innerWidth} selectedStation={selectedStation} setSelectedStation={setSelectedStation}
                        setTooltipX = {setTooltipX} setTooltipY = {setTooltipY} tooltipX={tooltipX} tooltipY={tooltipY}
                        />
                    </svg>
                </Col>
                <Col>
            ...
            */}
            {selectedStation && (
                <Tooltip station={selectedStation} x={tooltipX} y={tooltipY}  />
            )}
        </Container>
    )   
}
